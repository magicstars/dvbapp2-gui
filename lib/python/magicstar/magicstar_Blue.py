...
from magicstar.magicstar_skins import EGExecute_Skin, EGEmuInfoScript_Skin, EGEmuManager_Skin, EGEmuManagerStarting_Skin
from magicstar.magicstar_Green import EGExtrasMenu
from os import popen, listdir


class magicstarBluePanel:
	def __init__(self):
		self["magicstarBluePanel"] = ActionMap( [ "InfobarExtensions" ],
			{
				"magicstarBluePanelShow": (self.showmagicstarBluePanel),
			})

	def showmagicstarBluePanel(self):
...
class EGSoftCamInfo(Screen):
    skin = """<screen name="EGSoftCamInfo" position="center,center" size="400,310" title="magicstar Softcam Info" >
    ...
    def go(self):
		...
		from magic.WicarddInfo import magicstarWicarddMain
		self.session.open(magicstarWicarddMain)
...
class EmuManager(Screen):
	...
	def createSetup(self):
		...
		self["key_blue"] = Label(_("magicstar Panel"))
