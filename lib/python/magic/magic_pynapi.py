...
def usage():
    ...
    print >> sys.stderr
    print >> sys.stderr, "pynapi $Revision: 1.40 $"
    print >> sys.stderr
...
def readSubLang():
	try:
		fp = open("/etc/magic/.sub_lang", "r")
		subLangLine = fp.readline()
		fp.close()
		subLangLine = subLangLine.strip("\n")
		return subLangLine
	except:
		"PL"
		
def get_subtitle(digest, lang=readSubLang()):
