...
from magic.magic_tools import runBackCmd, unload_modules, wyszukaj_re, checkkernel, wyszukaj_in
from magic.magic_skins import EGProcessInfo_Skin, EGKernelInfo_Skin, EGAdvancedStreamInfo_Skin, EGSmartScript_Skin, EGSwapManager_Skin, EGKernelModulesManager_Skin, EGEnigma2ConfigInfo_Skin
