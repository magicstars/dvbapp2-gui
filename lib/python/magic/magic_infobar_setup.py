...
from magic.magic_skins import EGDecodingSetup_Skin, EGInfoBarSetup_Skin

from Plugins.Extensions.magicPermanentClock.plugin import *
...
class EGDecodingSetup(ConfigListScreen, Screen):
	...
	list.append(getConfigListEntry(_('Show magic informations?'), config.EGDecoding.dsemudmessages))
